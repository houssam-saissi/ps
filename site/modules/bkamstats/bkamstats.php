...
class Bkamstats extends ModuleGrid
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Bkam Stats');
        $this->description = $this->l('Stats for BKAM Backend');
    ...
    public function install()
    {
        ...
        /*
		Configuration::updateValue('BKAMSTATS_LIVE_MODE', false);
