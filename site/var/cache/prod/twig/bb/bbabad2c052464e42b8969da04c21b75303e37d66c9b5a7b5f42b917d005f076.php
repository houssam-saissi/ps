...
class __TwigTemplate_1b0320d0cc35fd7d37648738725b96c620eeca2d5b9e2c3d4af3c3ac9fe31b3c extends \Twig\Template
{
...
";
    ...
    public function block_category_cover_image($context, array $blocks = [])
    {
        // line 27
        echo "  ";
        if (((isset($context["coverImage"]) || array_key_exists("coverImage", $context)) &&  !(null === ($context["coverImage"] ?? null)))) {
            // line 28
            echo "    <div>
      <form action=\"\">
        <figure class=\"figure\">
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Categories/Blocks/cover_image.html.twig", "/var/www/vhosts/wyxar.com/ps.wyxar.com/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Categories/Blocks/cover_image.html.twig");
    }
}
