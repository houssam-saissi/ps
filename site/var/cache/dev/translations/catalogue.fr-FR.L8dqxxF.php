...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Reference #' => 'Référence',
    'Supplier reference #' => 'Référence fournisseur',
    'Delivery time of out-of-stock products with allowed orders:' => 'Délai de livraison des produits en rupture de stock avec commande autorisée:',
  ...
  array (
    ...
    'Click on "Displayed" to index the category on your shop.' => 'Cliquez sur  "Affichée"  pour indexer la catégorie sur votre boutique.',
  ...
  array (
    ...
    'An error occurred while creating customization fields.' => 'Une erreur s\'est produite lors de la création des champs personnalisés.',
  ...
  array (
    ...
    'Be careful! Please check your theme in an RTL language before generating the RTL stylesheet: your theme could be already adapted to RTL.\\nOnce you click on "Adapt to RTL", any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.' => 'Attention ! Veuillez vérifier que votre thème est dans une langue RTL avant de générer une feuille de style RTL : votre thème pourrait déjà être compatible RTL.\\nEn cliquant sur "Adapter en RTL", n\'importe quel fichier spécifique au RTL que vous auriez ajouté à votre thème pourrait être supprimé par la feuille de style créée.',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.' => 'Attention ! Veuillez vérifier que votre thème est dans une langue RTL avant de générer une feuille de style RTL : votre thème pourrait déjà être compatible RTL. En cliquant sur "%generate_rtl_label%", n\'importe quel fichier spécifique au RTL que vous auriez ajouté à votre thème pourrait être supprimé par la feuille de style créée.',
  ...
  array (
    ...
    'Not all images have been moved. The server timed out before finishing. Click on "Move images" again to resume the moving process.' => 'Toutes les images n\'ont pas pu être déplacées,  le serveur a expiré avant la fin de l\'opération. Cliquez à nouveau sur \\"Déplacer les images\\" pour reprendre l\'opération.',
    ...
    'Your theme has been correctly reset to its default settings. You may want to regenerate your images. See the Improve > Design > Images Settings screen for the \'Regenerate thumbnails\' button.' => 'Votre thème a été correctement réinitialisé. Vous devriez régénérer vos miniatures. Pour cela, utilisez l\'option "Régénération des miniatures" qui se trouve dans le menu "Images" de la section "Apparence".',
...
',
  ...
  array (
    ...
    'You need permission to edit this.' => 'Vous devez être autorisé à modifier ce contenu.',
    ...
    'The value of the PHP.ini setting "max_input_vars" must be increased to %value% in order to be able to submit the product form.' => 'La valeur du paramètre PHP.ini "max_input_vars" doit être élevée à %value% afin de pouvoir soumettre le formulaire produit.',
...
Cordialement,',
  ...
  array (
    ...
    'Editing this product line will remove the reduction and base price.' => 'Modifier cette ligne de produit supprimera la réduction et le prix d\'origine.',
    'No voucher was found' => 'Aucun bon trouvé',
...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
  ...
  array (
    ...
    'By default, the Add to Cart button is hidden when a product is unavailable. You can choose to have it displayed in all cases.' => 'Par défaut, le bouton "Ajouter au panier" est masqué lorsqu\'un produit est indisponible. Vous pouvez choisir d\'afficher ce bouton dans tous les cas.',
  ...
  array (
    ...
    'Oops! Please correct the item(s) below, and then click "Refresh information" to test the compatibility of your new system.' => 'Oups ! Veuillez corriger le ou les élément(s) ci-dessous puis cliquez sur "Rafraîchir l\'information" afin de tester la compatibilité de votre nouveau système.',
    'Refresh' => 'Rafraîchir',
    ...
    'Your database login does not have the privileges to create table on the database "%s". Ask your hosting provider:' => 'Votre identifiant de base de données n\'a pas les droits pour créer une table sur la base de données "%s". Demandez à votre hébergeur :',
    ...
    'Cannot create group shop' => 'Impossible de créer le groupe de boutiques',
  ...
  array (
    ...
    'Are you sure you want to uninstall this module?' => 'Êtes-vous sûr de vouloir désinstaller ce module ?',
    'There was an error during the installation. Please contact us through Addons website.' => 'Une erreur s\'est produite lors de l\'installation. Contactez-nous sur le site web d\'Addons.',
    'There was an error during the uninstallation. Please contact us through Addons website.' => 'Une erreur s\'est produite lors de la désinstallation. Contactez-nous sur le site web d\'Addons.',
  ...
  array (
    ...
    'When a product is on sale, displays a \'Our previous price\' label before the original price crossed out, next to the price on the product page.' => 'Quand un produit est en promotion, ajoute sur la fiche produit un libellé "Notre ancien prix" avant le prix d\'origine barré, à côté du prix.',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    'Live translation' => 'Traduction contextuelle',
    ...
    'Unable to install the module: the English Upside Down language cannot be installed.' => 'Impossible d\'installer le module : la langue virtuelle "English Upside Down" n\'a pas pu être installée.',
  ...
  array (
    ...
    'PrestaShop was unable to log in to Addons. Please check your credentials and your Internet connection.' => 'PrestaShop n\'a pas pu se connecter à Addons. Veuillez vérifier vos identifiants et votre connexion Internet.',
    'Search for a product' => 'Rechercher un produit',
    'Your shop is in debug mode.' => 'Votre boutique est en mode de debug.',
    'All the PHP errors and messages are displayed. When you no longer need it, [1]turn off[/1] this mode.' => 'Tous les messages et erreurs PHP sont affichés. Lorsque vous n\'en avez plus besoin, [1]désactivez[/1] ce mode.',
    'Debug mode' => 'Mode debug',
    'Your shop is in maintenance.' => 'Votre boutique est en maintenance.',
    'Your visitors and customers cannot access your shop while in maintenance mode.%s To manage the maintenance settings, go to Shop Parameters > Maintenance tab.' => 'Vos clients et visiteurs ne peuvent y accéder actuellement. %s Vous pouvez gérer les paramètres de maintenance dans l\'onglet Maintenance de la page Paramètres de la boutique.',
